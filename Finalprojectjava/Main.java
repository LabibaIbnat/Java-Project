...
public final class Main extends Person{
	    ...
	    p1.id="1205";
	    p1.name="shadin";
	    p1.setDisease("Heart disease") ;
	    p1.setSex(" Male");
	    p1.setAdmit_status("\tAdmitted ");
	    p1.setAge("  70");			    
	    Patient p2=new Patient();
	    p2.id="1208";
	    p2.name="Ashfia";
	    p2.setDisease("Liver disease") ;
	    p2.setSex(" Female");
	    p2.setAdmit_status("\tNotAdmitted ");
	    p2.setAge("  40");			    
	    Patient p3=new Patient();
	    p3.id="1209";
	    p3.name="Tania";
	    p3.setDisease(" \tBrain stroke ") ;
	    p3.setSex(" Female");
	    p3.setAdmit_status("\tAdmitted ");
	    p3.setAge("  45");			    
	    Patient p4=new Patient();
	    p4.id="1212";
	    p4.name="Farabi";
	    p4.setDisease("Bone fraction") ;//disease="Heart attack" ;
	    p4.setSex(" Male");
	    p4.setAdmit_status("\tNotAdmitted ");
	    p4.setAge("  23");
	    Patient p5=new Patient();
	    p5.id="";
	    p5.name="";
	    p5.setDisease("") ;//disease="Heart attack" ;
	    p5.setSex(" ");
	    p5.setAdmit_status("\t ");
	    p5.setAge("  ");
